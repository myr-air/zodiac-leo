...
| Song-source guardrails | Episode Style & Theme Spine, Track Delta, Story + Reference Brief, strict pattern gate, lexical ledger, BPM in `Styles` | lyrics, title, style/exclude/control fields, provider/model assumptions, or reference strategy changes |
