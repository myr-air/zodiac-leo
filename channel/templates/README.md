...
Default rule for the next videos: use the compact fastlane worksheet first, cite approved channel defaults once, and re-review only changed episode deltas or newly opened local/external gates.
