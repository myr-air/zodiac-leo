...
- Audio candidate intake is recorded in `reviews/audio-candidate-intake.md`; user human listening pass and Gemini supplemental lyric anchor spot-check pass are recorded for all 13 selected draft candidates in `reviews/audio-qa-listening.md`. Selected draft duration is about 41:31 and still needs a duration/sequence decision.
...
Verdict: `selected_draft_human_listen_lyric_alignment_passed_needs_duration_decision_source_only`
