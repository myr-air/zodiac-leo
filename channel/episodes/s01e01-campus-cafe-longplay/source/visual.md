...
This file is a still-frame and layout plan only. It does not approve image generation, image editing, reference-image input use, screenshots, candidate media, render/export, upload, publishing, provider/account/API/browser automation, or positive rights/platform claims.
...
|---|---|---|
| Episode title | upper-left or upper-center with at least 12 percent top margin | negative space only; no face or key object underneath |
| Track/chapter cue | small lower-left or side card if later needed | must stay secondary to image and not keyword-stuffed |
| Subtitles | lower 18 percent | background should be simple and readable after overlay |
| Equalizer | optional small bottom-right | low contrast and away from subtitles and character |
