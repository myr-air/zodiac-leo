...
Status: source-only v6 visual direction passed / subtitle improvement gate open  
...
- Subtitle source: lyric timing is still pending a separate subtitle timing/final timeline step.
