...
|---|---|---|
| Video candidate | `candidates/s01e02-classroom-window-longplay/render/local-render-02/video/s01e02-classroom-window-longplay.local-render-02-draft-subtitled-1080p24-qa.mp4` | Repaired, user-approved final-video candidate. |
| Metadata source | `channel/episodes/s01e02-classroom-window-longplay/source/metadata.md` | Gate 1 title, description, chapters, tags, and disclosure source. |
| API helper | `scripts/youtube_api_video_upload.py` | Generic guarded dry-run default helper. |
| API resource JSON | `channel/episodes/s01e02-classroom-window-longplay/source/youtube-video-resource.json` | Request body for `videos.insert`; validates `privacyStatus: private` and no captions/thumbnail fields. |
...
```text
Scope: S01E02 render-02 MP4 upload through YouTube Data API videos.insert only
Mode: pending execution for private upload only
