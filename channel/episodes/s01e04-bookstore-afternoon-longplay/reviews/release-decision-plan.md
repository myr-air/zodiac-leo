# S01E04-BOOKSTORE-AFTERNOON-LONGPLAY Release Decision Plan — Bookstore Afternoon Longplay
...
Current assets: final MP4 render-01 (`9703dfb504f822`) + source `.srt/.vtt` + public YouTube asset `OMjvEEAIFSU` (thumbnail uploaded) + top-level comment `UgxE0B311LZs6GvMiEN4AaABAg` posted (latest)
