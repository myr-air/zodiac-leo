...
Build one coherent weekly music channel, not random AI-song batches. Each episode needs a location/time hook, a consistent cozy vocal sound, concrete lyric craft, visual safe zones, human review, and disclosure.
...
| Week | Working longplay | Hook | Lyric lane |
|---:|---|---|---|
| 9 | Blue Coast Morning Longplay | quiet coast, early sun | new day, gentle optimism |
| 10 | Boardwalk Breeze Longplay | boardwalk, warm wind | easy affection, simple freedom |
| 11 | Beach Cafe Longplay | seaside cafe, open shade | comfort, gratitude, low-stakes romance |
| 12 | Salt-Air Afternoon Longplay | late summer horizon | growth, release, open future |

## Quality Bar

- Reject generic AI filler, repeated lyric grids, named imitation, harsh audio artifacts, unsafe visual prompts, weak disclosure, or unsupported platform claims.
- Keep revision loops gate-based rather than endless micro-edits.
- Treat analytics and release decisions as future separate gates.
